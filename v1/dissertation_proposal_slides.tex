...
% Custom footline with section indicator and publication info
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Scalable to large language models \citep{brown2020language,devlin2018bert,raffel2020exploring}
        \item Question-answer consistency across transformer layers \citep{vaswani2017attention}
    \end{itemize}
    ...
    \end{itemize}
    \item \textbf{Validation}: Natural Questions \citep{kwiatkowski2019natural}, TriviaQA \citep{joshi2017triviaqa}, HaluEval \citep{li2023halueval}, TruthfulQA \citep{lin2022truthfulqa}, HalluLens \citep{bang2025hallulens}
\end{itemize}
\end{frame}

% SECTION 3: DETAILED TECHNICAL CONTRIBUTIONS (20 slides, ~30 minutes)

% 3a. Label Blindness Deep Dive (7 slides)
\renewcommand{\sectionpubinfo}{\hspace{1ex}(Published at ICLR 2025)}
\section{Label Blindness Deep Dive}

% 8. Motivating Example: GradCAM Visualization
\begin{frame}{Motivating Example: When Features Mislead}
\begin{center}
\includegraphics[width=0.8\textwidth]{images/gradcam_example_faces.png}
\end{center}
\vspace{0.5cm}
\textbf{High Gradient Areas for Facial Expressions when trained without Labels}

\vspace{0.3cm}
Notice that the neural network focuses on easy to identify features (e.g., glasses) rather than the features relevant for facial expression classification.

\vspace{0.2cm}
\footnotesize{GradCAM visualization \citep{selvaraju2017grad}}
\end{frame}
...
% 3b. Domain Feature Collapse Deep Dive (7 slides)
\renewcommand{\sectionpubinfo}{\hspace{1ex}(Submitted to AAAI 2026)}
\section{Domain Feature Collapse Deep Dive}

% 14. Motivating Question: What Do We Really Learn?
\begin{frame}{Motivating Question: What Do We Really Learn?}
\begin{columns}
\begin{column}{0.5\textwidth}
\centering
\includegraphics[width=0.9\textwidth]{images/butterfly_1_sample.jpg}
\end{column}
\begin{column}{0.5\textwidth}
\centering
\vspace{1.5cm}
\Large
\textbf{We learn butterfly features,\\[0.3cm] but do we learn the butterfly shape?}
\end{column}
\end{columns}
\end{frame}
...
\renewcommand{\sectionpubinfo}{\hspace{1ex}(Work In Progress)}
...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Theoretical Foundation}: Information Bottleneck Principle \citep{tishby2000information}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{Real-world benchmarks}: HaluEval \citep{li2023halueval}, TruthfulQA \citep{lin2022truthfulqa}, FEVER \citep{thorne2018fever}, HalluLens \citep{bang2025hallulens}
        \item Cross-method consistency analysis (MINE \citep{belghazi2018mutual}, InfoNCE \citep{oord2018representation}, kernel-based)
    \end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Computational efficiency: 10-100x faster than MINE \citep{belghazi2018mutual}
