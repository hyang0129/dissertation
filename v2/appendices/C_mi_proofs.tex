...
supervises both classes symmetrically, confirms it: relative to the one-class
asymmetric scheme, symmetric supervision substantially degrades detection on both
supported models, falling well below both asymmetric anchors.
