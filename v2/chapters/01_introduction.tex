...
A language model's intermediate activations may preserve information associated
with a generation that the benchmark marks incorrect, even when the final output
does not reveal that error.
...
\begin{enumerate}
  ...
  comparison. An ablation supports a conditional prediction of the argument: when
  hallucinated examples lack coherent latent structure, supervising both classes
  symmetrically degrades detection. Proofs appear in
