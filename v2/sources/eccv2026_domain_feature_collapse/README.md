...
- Either compile with `pdflatex` as
    ...
    This folder is configured as its own Git repository, so it can be pushed and cloned independently from the parent project.

    1. Create an empty remote repository (for example, `hyang0129/eccv2026-paper`).
    2. From this folder, add the remote and push:

        git remote add origin https://github.com/hyang0129/eccv2026-paper.git
        git push -u origin main

    3. Clone only the paper repository anywhere with:

        git clone https://github.com/hyang0129/eccv2026-paper.git
